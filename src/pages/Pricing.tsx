...
import { Check, Star, ArrowLeft, Palette, FileText, Wrench, Zap, Code, ShoppingCart, Search, PenTool, Settings, ArrowRight, Layers, Copy, Wallet } from "lucide-react";
          ...
          <Card className="p-6 border-2 border-amber-500/30 bg-amber-500/5">
            ...
            <div className="flex items-center gap-3 bg-background rounded-lg p-4 border border-border">
              <code className="flex-1 text-sm font-mono text-foreground break-all select-all">
                0x1ae2349ac387403fa068f34f9fdff71f580f0ee7
              </code>
              <Button
                variant="outline"
                size="sm"
                className="shrink-0"
                onClick={() => {
                  navigator.clipboard.writeText("0x1ae2349ac387403fa068f34f9fdff71f580f0ee7");
